...
predict_single_patient <- function(
  ...
  patient <- list(
    ...
    crt.long = crt.long,
    oxy.ra = oxy.ra,
    LEVEL1_TREATMENTS_D1_SAFE_0 = LEVEL1_TREATMENTS_D1_SAFE_0,
    LEVEL2_TREATMENTS_D1_SAFE_0 = LEVEL2_TREATMENTS_D1_SAFE_0,
    LEVEL3_TREATMENTS_D1_SAFE_0 = LEVEL3_TREATMENTS_D1_SAFE_0,
    LEVEL4_TREATMENTS_D1_SAFE_0 = LEVEL4_TREATMENTS_D1_SAFE_0,
    LEVEL5_TREATMENTS_D1_SAFE_0 = LEVEL5_TREATMENTS_D1_SAFE_0
  )
  ...
  resp <- httr2::request(paste0(base_url, "/predict/day2")) |>
